...
@implementation PKSTableViewCell
...
// 通过set方法在conunterList刚被赋值时，对其他控件进行赋值
...
- (NSAttributedString*)makeText :(NSString*)exampleString{
    ...
    NSDictionary * dictA = @{NSFontAttributeName:[UIFont systemFontOfSize:15],
